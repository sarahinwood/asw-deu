...
DEGs <- fread("output/dexseq/dtu_exposed_location_analysis/sig_degs.csv")
...
fwrite(plot_results_dt, "output/dexseq/dtu_exposed_location_analysis/exposed_GO_enrichment.csv")
